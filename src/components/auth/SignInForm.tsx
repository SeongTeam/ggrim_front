...
export interface SignInFormProps{
    formAction : (email : string,password :string) => Promise<boolean|HttpException|ServerActionError>,
    NextRoute : string;  
}
        ...
        <div>
          <form onSubmit={handleSignIn} className="flex flex-col gap-4">
            ...
            <input
              ...
              required
            />
            <button type="submit" className="bg-red-600 hover:bg-red-700 transition p-3 rounded font-semibold">
              Sign In
            </button>
          </form>
        </div>
